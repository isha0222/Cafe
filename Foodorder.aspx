<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Foodorder.aspx.cs" Inherits="Foodorderaspx" %>
    ...
    <nav id="navbar">
        ...
        <div class="right">
            <ul class="ruf">
                ...
                <li class="itm"><a href="signup1.aspx" target="_self"> <asp:Label ID="Signup" runat="server" Text="SIGN UP"></asp:Label></a>
    ...
    <section class="service-container">
        ...
        <div id="service">
            <div class="box">
                ...
                <div class="fod">
                    <h2 class="h-third"><a href="foodcart.aspx" target="_blank"
            ...
            <div class="box">
                ...
                <h2 class="h-third"><a href="drinkscart.aspx" style="text-decoration: none; color: white;">
                DRINKS & SHAKES</a>
            ...
            <div class="box">
                ...
                <h2 class="h-third"><a href="dessertcart.aspx" style="text-decoration: none; color: white;">DESSERT</a></h2>
                    <p class="text-center">
                        ...
                        commodi, exercitationem autem doloremque!</p>
