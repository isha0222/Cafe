...
<head runat="server">
    ...
    <style>
        body {
            background-image: url(homebooking.jpg);
...
<body>
    ...
    <form id="form1" name="my_form" class="box" runat="server">
        <h1>TABLE BOOKING</h1>
        <asp:TextBox name="username" id="username" placeholder="Name" type="text" runat="server" required=""> </asp:TextBox>
        <asp:TextBox name="email" id="email" placeholder="Enter Email" type="text" runat="server" required=""></asp:TextBox>
        <asp:TextBox name="phone" id="phone" placeholder="Mobile No" type="text" runat="server" required=""></asp:TextBox>
        <asp:TextBox name="people" id="people" placeholder="No. of People" type="text" runat="server" required=""></asp:TextBox>
        <asp:TextBox name="date" id="date" class="date" placeholder="DD-MM-YYYY" runat="server" required=""></asp:TextBox>
        <asp:TextBox name="suggetion" ID="suggetion" TextMode="MultiLine" placeholder="Suggetion"  class="textarea" runat="server" required=""></asp:TextBox>
    <asp:Button id="Submit"  value="submit" Text="Submit" name="submit" runat="server" OnClientClick="booking()" OnClick="Submit_Click"></asp:Button>
   <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Invalid mobile number" ControlToValidate="phone" ForeColor="Red" ValidationExpression="^[7-9][0-9]{9}$" Display="Dynamic" ></asp:RegularExpressionValidator>
    ...
    <script>
        function booking() {
            alert("booking sucessfull...Thank you !");
