    ...
    <section class="service-container">
        ...
        <div id="service">
            <div class="box">
                ...
                <div class="fod">
                    <h2 class="h-third"><a href="Foodorder.aspx" 
            ...
            <div class="box">
                ...
                <h2 class="h-third"><a href="catering1.aspx" 
                    style="text-decoration: none; color: white;">CATERING</a></h2>
                <p class="text-center">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae molestiae cumque quo reiciendis
                    unde voluptatem voluptatibus rem in optio dolor, facere ad sint minima vel ratione commodi,
                    exercitationem autem doloremque!
            ...
            <div class="box">
                ...
                <h2 class="h-third"><a href="booking1.aspx" 
   style="text-decoration: none; color: white;">
    BOOKING</a>
    </h2>
    <p class="text-center">
