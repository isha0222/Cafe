 ...
 <title>CONTACT US</title>
        ...
        <style>
            body{
                ...
                background-image: url(1000_F_206925823_SgmybBfJWW2pnWvywT0QGOZBfGpkUg2m.jpg);
                background-repeat: no-repeat;
                /* background:url('img/cafe.webp') no-repeat center center/cover; */
...
<body>
    ...
    <form id="form1" runat="server">  
        <h1>CONTACT US</h1>
            <div class="h">
                <div class="ch">
                    Name : 
                    <asp:TextBox name="name" id="name" class="cm" runat="server" required=""></asp:TextBox>
                </div>
                <br />
                
                <div class="ch">
                    Email :
                    <asp:TextBox name="email" id="email" class="cm" runat="server" required=""></asp:TextBox>
                </div>
                <br />
                 
                <div class="ch">
                    Contact No :
                    <asp:TextBox name="phone" id="phone"  class="cm" runat="server" required=""></asp:TextBox>
                </div>
             
                <br />
                <div class="ch">
                    Suggestion :
                    <asp:TextBox name="suggetion" TextMode="MultiLine" placeholder="suggetion" class="cm" ID="suggetion" runat="server" required=""></asp:TextBox>
                </div>
                <br />
                <div class="ch">
                    <asp:Button id="Submit" class="btn" type="submit" value="submit" runat="server" Text="Submit" OnClientClick="contact()" OnClick="Submit_Click" />
                    </div>
    ...
    <div class="contactInfo">
            <!-- <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
              ...
              </svg> - LOCATION : Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam, quasi ad nemo dolor veniam laudantium.</p>
               <p> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                
              </svg> - PRIYA PATEL & ISHA SANGHAVI</p>
